...
ACTIONS = ["back","down","forward","left","right","up"]

def split_data(starting_dir="updated_data", splitting_percentage=(70, 20, 10), shuffle=True, coupling=False,
               division_factor=0):
    ...
    if not os.path.exists("training_data") and not os.path.exists("validation_data") \
        ...
        for action in ACTIONS:
            ...
            for file in sorted(os.listdir(data_dir)):
                ...
                all_action_data.append(pd.read_csv(os.path.join(data_dir, file)))
